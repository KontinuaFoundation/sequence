...
\end{equation}
Note that $v_0$ and $v_i$ are synonymous, some professors will use $v_0$ to mean ``velocity not`` or initial velocity.
\end{mdframed}
...
%explanation of constant time interval motion diagrams

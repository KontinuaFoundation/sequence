...
Archimedes estimated the circumference of 
...
Now, it's easy to find the length of a polygon: 
...
be used to signify the length or \textbf{magnitude} of something). Therefore, the sum of 
...
The length of each segment can be found using the Pythagorean theorem. 
...
Putting this all together, we see that the actual length of the 

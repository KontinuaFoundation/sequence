...
When larger bodies are under consideration for Newton's Universal Law of Gravity (Equation~\ref{eq:univGrav}), the gravitational force on both objects increases linearly. Bigger masses lead to greater forces between them. This is most noticable with planets and moons; moons and planets keep each other in-orbit through the gravitational force between them.

...
\centering
  ...
  \end{tikzpicture}
  \caption{A figure of the direction of force vectors for a graviational field.}
  \label{fig:grav_field}
\end{figure}

  All vectors in a gravitational field point to the center of mass of that field. The larger the body, as we said, the greater the force, and thus the greater magnitude of vectors. Thus, a gravitional field around a mass $M$ is a \newterm{vector field}, a term you will hear in vector calculus sections, or an assignment of of a vector to every point in space. Every point has a force assignment based on the \textbf{radius} between the two objects.

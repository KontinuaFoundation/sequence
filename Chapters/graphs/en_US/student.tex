...
%FIXME sequence issue 70 regarding this
...
data can flow from Raleigh to Charlotte. Most graphs are shown as undirected.
...
\begin{figure}[H]
    ...
    \caption{A graph with some not connected nodes.}

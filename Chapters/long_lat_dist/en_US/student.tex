...
\begin{figure}[H]
    ...
    \caption{Longitude illustrations.}
\end{figure}
...
\begin{itemize}
  ...
  \item \textbf{Rio de Janeiro, Brazil}: $22^\circ$ S $43^\circ$ W
\end{itemize}

These coordinates may be broken down further into minute and second components as well, for further geometric accuracy.
...
\begin{itemize}
  ...
  \item \textbf{Rio de Janeiro, Brazil}: $22^\circ$ 54` 0" S $43^\circ$ 12` 0" W
\end{itemize}
...
The \newterm{haversine formula} is an important equation in navigation for

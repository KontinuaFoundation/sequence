...
It's a common misconception that objects in motion are accelerating. If an object 
is moving with a constant velocity (same speed, same direction), then it is not 
accelerating. 
...
two objects. Let's look at a person standing at rest:

%fix me stick person standing on a floor

We know that gravity is pulling down on the person:

%fix me add gravity vector

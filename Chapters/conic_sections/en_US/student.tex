...
Note that only the parabola out of these four is a function, as it passes vertical line test. The other three cannot be expressed as functions, only equations.
% talk about asymptotes in this chapter
...
had only one of the two shots tested negative for the virus.
...
probability that one of them has the virus?''

The first thing you might do is make a new table that shows the probability of a randomly chosen student being in any particular
...
study group together, what is the probability that \textit{none} of
...
positive test \textit{and} both vaccination shots by the probability
...
% ^ above is a link to chain rule for calculus

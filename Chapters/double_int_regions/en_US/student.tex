...
\begin{tikzpicture}
    ...
    axis lines = center, ticks = none, xlabel = $x$, ylabel = $y$] 
        ...
        (0.767, 1.4) -- (0.899, 1.25) -- (1.004, 1.1) -- (1.073, 0.95) --
        (1.087, 0.9) -- (1.096, 0.85) -- (1.1, 0.8) -- (1.099, 0.75) --
        (1.093, 0.7) -- (1.083, 0.65) -- (1.021, 0.5) --
        (0.922, 0.35) -- (0.795, 0.2) -- cycle;

        \addplot[name path=A, domain=0.2:2.9, orange, thick, samples=100]
            (0.5*sin(deg(2*x)) + 0.6, x);
        \addplot[name path=B, domain=0.2:2.9, orange, thick, samples=100]
            (0.5*cos(deg(3*x)) + 2, x);
...
\begin{tikzpicture}
    ...
    axis lines = center, ticks = none, xlabel = $x$, ylabel = $y$] 
        ...
        \addplot[name path=A, domain=0.295:2.9, orange, thick, samples=150]
            (sqrt(x + 1) + 0.5, x);
        \addplot[name path=B, domain=0.295:2.9, orange, thick, samples=150]
            (-2*sqrt(x)/3 + 2, x);
...
We could classify this as a type I (see figure \ref{fig:typeI_sub}) or a 
type II domain (see figure \ref{fig:typeII_sub}). 
\begin{figure}[H]
\centering
...
\caption{Type I region: $\frac{(x-1)^2}{2} \le y \le \frac{3(x-1)}{2}$}
\label{fig:typeI_sub}
\end{subfigure}\hfill%
\begin{subfigure}{0.48\textwidth}
\centering
...
\caption{Type II region: $\frac{2y}{3} + 1 \le x \le \sqrt{2y} + 1$}
\label{fig:typeII_sub}
\end{subfigure}

\caption{Comparison of Type I and Type II descriptions of the same region.}
\label{fig:typeI_typeII_combined}
\end{figure}
...
\end{axis}
\end{tikzpicture}
\caption{A domain that \emph{is} Type I}
\label{fig:vertical_line_typeI}
\end{subfigure}
\hfill
%--------------- SUBFIGURE 2 (RIGHT) ----------------%
\begin{subfigure}{0.48\textwidth}
...
\begin{tikzpicture}
\begin{axis}[ymin = -0.3, ymax = 4, xmin = -0.3, xmax = 3, 
axis lines = center, ticks = none, xlabel = $x$, ylabel = $y$, clip = false] 

    \draw[orange, fill = orange!30] 
        (0.8, 0.2) -- (2.41, 0.2) --
        (2.25, 0.35) -- (2.04, 0.5) -- (1.81, 0.65) --
        (1.63, 0.8) -- (1.52, 0.95) -- (1.505, 1) -- (1.5, 1.05) --
        (1.506, 1.1) -- (1.524, 1.15) -- (1.552, 1.2) -- (1.59, 1.25) --
        (1.75, 1.4) -- (1.97, 1.55) -- (2.19, 1.7) -- (2.37, 1.85) --
        (2.417, 1.9) -- (2.454, 1.95) -- (2.48, 2) -- (2.496, 2.05) --
        (2.5, 2.1) -- (2.493, 2.15) -- (2.475, 2.2) -- (2.447, 2.25) --
        (2.41, 2.3) -- (2.24, 2.45) -- (2.03, 2.6) -- (1.81, 2.75) --
        (1.63, 2.9) -- (0.365, 2.9) -- (0.247, 2.75) -- (0.158, 2.6) --
        (0.109, 2.45) -- (0.102, 2.4) -- (0.1, 2.35) -- (0.103, 2.3) --
        (0.111, 2.25) -- (0.124, 2.2) -- (0.142, 2.15) --
        (0.222, 2) -- (0.335, 1.85) -- (0.472, 1.7) -- (0.621, 1.55) --
        (0.767, 1.4) -- (0.899, 1.25) -- (1.004, 1.1) -- (1.073, 0.95) --
    ...
    \draw[latex-] (1.9, 1) -- (2.2, 1.3)
        node[above, font=\scriptsize, xshift=0.5cm]
        {the vertical line leaves the domain};

\end{axis}
\end{tikzpicture}
\caption{A domain that is \emph{not} Type I}
\label{fig:vertical_line_not_typeI}
\end{subfigure}

\caption{Comparing two regions: one that satisfies the Type I condition and one that does not.}
\label{fig:vertical_line_subfig}
\end{figure}
...
axis lines = center, ticks = none, xlabel = $x$, ylabel = $y$] 
    ...
    \draw[latex-] (1.6667, 2.43) -- (1.25, 3)
        node[above, font=\scriptsize]
        {the horizontal line leaves the domain};

\end{axis}
\end{tikzpicture}
\caption{A domain that is \emph{not} Type II}
\label{fig:horizontal_line_not_typeII}
\end{subfigure}\hfill
%-------------- SUBFIGURE 2 (RIGHT) ---------------%
\begin{subfigure}{0.48\textwidth}
\centering
...
\end{axis}
\end{tikzpicture}
\caption{A domain that \emph{is} Type II}
\label{fig:horizontal_line_typeII}
\end{subfigure}

%-------------- MAIN CAPTION ----------------%
\caption{Comparing two regions: one that fails the Type II condition and one that satisfies it.}
\label{fig:horizontal_line_subfig}
\end{figure}

...
% writers note: this chapter is currently located in the middle of the calculus section, but it would be useful to move it to end of precalc section or before physics stuff, since circular_1 and circular_2 reference parametric functions.

...
Choosing a specific system or environment will benefit your problem, especially if the netexternal work done is $0$.
...
\begin{mdframed}[style=important, frametitle={Formula for Power}]
	...
	Equivallently, for work done by constant forces, this simplifies to $P=\frac{W \cdot r}{t} = F \cdot v$, since 
\end{mdframed}

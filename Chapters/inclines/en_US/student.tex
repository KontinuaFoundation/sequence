...
\begin{figure}[H] \centering \caption{A box on an inclined plane with $a=0$ due to static friction and gravity.} \begin{tikzpicture}[scale=1, line cap=round, line join=round]  
    \coordinate (A) at (0,0); 
    \coordinate (B) at (5,0); 
    \coordinate (C) at (5,2); 

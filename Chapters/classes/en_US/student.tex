...
and they can contain custom variables referred to as attributes.\index{attributes}
...
When a function is associated with a datatype like this, it is called a
...
Parent classes (ie `Animal') give a subclass (or child) different attributes or methods. Let's check out an example:

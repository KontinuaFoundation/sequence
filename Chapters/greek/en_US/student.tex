...
You will see a lot of equations that reference Greek letters, using them as \emph{placeholders}, \emph{constants}, or \emph{variables} for an unknown quantity. For example, there area of a circle is given by

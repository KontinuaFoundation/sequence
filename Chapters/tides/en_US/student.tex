...
The Earth, the moon, and the sun form a triangle. If you were standing on the moon, you could measure the angle between the light coming from the sun and the light going to the Earth. That angle would fluctuate between 0 degrees and 180 degrees.  
\begin{itemize}
...
\begin{figure}[H]
    ...
    \caption{The moon revolves around the Earth in different phases every month.}
    \label{fig:moonPhase}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{A rotating representation of the moon's phases.}
...
We call the plane that the Earth orbits the sun in the \newterm{ecliptic plane}.   The plane of the moon's orbit is about 5$^\circ$ tilted from the ecliptic plane.
...
The sun is pretty big, so if the moon blots out just part of it,  we call it a \newterm{partial solar eclipse}, as seen in Figure~\ref{fig:eclipseShadows}. There are a few partial solar eclipses every year. Note that because the moon's shadow is too small to shade the whole Earth, only certain parts of the world will experience any solar eclipses. 
...
% we have already included these above
...
\section{Tides}
%FIXME diagrams for tides section?
\index{tides}
...
The center of the moon and the center of the Earth rotate around each other. The point they rotate around is inside the Earth, but it is closer to the surface of the earth than it is to the center of the Earth. This is referred to as a \newterm{barycenter}.\index{barycenter}
...
The Earth is still rotating.  If you are at the beach as your longitude slides into one of these bulges,   you say ``Hey, the tide is rising!''  The peak of these bulges is known as ``\newterm{high tide}''. Because there is a bulge on each side of the planet, high tide comes twice a day.

This is a \newterm{lunar tide} -- because it is caused by the moon. There is a similar effect from the sun, but the sun is very, very far away: solar tidal forces are about half as powerful lunar tidal forces. When the sun and the moon work together,   the tides are stronger.  This is called a \newterm{spring tide}. Spring tides don't happen in the spring time;  they happen close to full moons and new moons.
...
If the Earth were still and alone in the universe,  there would still be the force of gravity.  We have said that a kilogram on the surface of the Earth is pulled toward the center of the earth with a force of 9.8 N.   
...
The force due to the moon's gravity is about 6\% stronger when the moon is overhead than when it is underfoot. 

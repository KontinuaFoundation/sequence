...
two (or more) angles which add up to $90^\circ$ are \emph{complementary} angles.\index{complementary angles} For example, 2 $45^\circ$ angles are complementary, as well as $30^\circ$ and $60^\circ$. If an angle is $65^\circ$, we say that its \emph{complement} is $90^\circ-65^\circ=25^\circ$.

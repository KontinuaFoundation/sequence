...
% One of my teachers told me half of understanding math is understanding mathematicians are just lazy, maybe a good add in somewhere
  ...
  \begin{center}
    \begin{tikzpicture}[scale=1.25]
      \begin{axis}[
        ...
        \addplot[thick,no marks,red,domain=-1:2]{x^2}; %inclusive on both ends
        ...
        \addplot[thick,no marks,funcolor,domain=2:5]{3-x}; %inclusive on right end

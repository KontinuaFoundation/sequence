...
\subsection{Relating Rotational Newton's Second Law and }
...
This theorem is especially useful when the axis of rotation does not pass through the center of mass. In many practical situations, such as a door rotating about its hinges or a rod rotating about one end, the axis of rotation is offset from the center of mass, making direct calculation more difficult.

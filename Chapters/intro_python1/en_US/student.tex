...
We can change what separates each variable by the \mintinline{python}{sep=} argument. 
\begin{minted}{python}
x = "it is"
y=78
z="degrees outside"
...
\begin{description}
    ...
    \item[Sequence Types] Sequences are consecutive lists or pairs of other data types can be represented in various forms: \mintinline{python}{list}, \mintinline{python}{set}, and \mintinline{python}{tuple}. Values are accessed by positions. \index{sequence types}
...
Logical operators can be used to combine conditions. Conditions can be \emph{strung together} using \mintinline{python}{and}, \mintinline{python}{or}, and \mintinline{python}{not}

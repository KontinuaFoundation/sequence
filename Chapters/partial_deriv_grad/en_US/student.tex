...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{The contour plot shows the elevation of a mountain. $H_x$ gives 
    the slope going east, while $H_y$ gives the slope going north}
    \label{fig:mountain}
\end{figure}

At some point, $(x_o, y_o)$, the partial derivatives $H_x(x_o, y_o)$ and $H_y(x_o, y_o)$ give the rate of change of elevation in the east-west and north-south directions, respectively (see figure \ref{fig:mount_deriv}). To find the rate of change at $(x_o, y_o)$, in the direction of some arbitrary unit vector, $\textbf{u} = \left[ a, b \right] = a\textbf{i} + b\textbf{j}$, we first note that the point $(x_o, y_o, z_o)$, where $z_o = H(x_o, y_o)$, lies on the surface defined by $z = H(x, y)$. There is a vertical plane, $P$, that passes through $(x_o, y_o, z_o)$ and points in the direction of \textbf{u}. This intersection defines curve $C$, which lies on the surface, and the slope of this curve at $(x_o, y_o, z_o)$ is the directional derivative of $H$ in the direction of \textbf{u} (see figure \ref{fig:direct_deriv}). 
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        (17.5, 17.4) (18, 17.35) (18.5, 17.2) (19, 17) (19.5, 16.9) 
        (20, 16.8)};
        \draw[black, fill = black] (10, 4) circle (0.5mm);
        ...
        font = \scriptsize] {$D_u [H(x, y)]$};
        \draw[-latex, black, thick] (17.75, 17) -- (17.75, 19.5);
        \draw[black, thick] (17.25, 17.7) -- (18.25, 17.7);
        \end{axis}
    \end{tikzpicture}
    \caption{If \textbf{u} points north-east, then the directional derivative 
    of $H(x, y)$, $D_u \left[ H(x, y ) \right]$, tells the rate of change 
    going north-east}
...
\begin{figure}[htbp]
    ...
    z = {(0cm, 1cm)}]
        ...
        node[right, font = \scriptsize] {$(x_o, y_o, z_o)$};
        ...
        node[left, font = \scriptsize] {$D_u$}; 
    \end{tikzpicture}
    \caption{The slope of the curve formed between the plane parallel to 
    \textbf{u} and the surface $z = H(x, y)$ is the directional derivative, 
    $D_u$}
...
A partial differential equation that has applications in fluid dynamics and electronics is Laplace's equation\index{Laplace's equation}. Solutions to Laplace's equation are called \textit{harmonic functions}. 

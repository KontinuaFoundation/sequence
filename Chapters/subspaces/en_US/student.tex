...
FIXME exercise
FIXME Big emphasis that solving for the nullspace tells you whether a set of vectors of independent or not. 
% If every column of the RREF has a leading 1 (pivot), then the columns are
% linearly independent.

% If one or more columns do not contain a pivot, then the columns are
% linearly dependent.
\section{Row Space}
\index{row space}

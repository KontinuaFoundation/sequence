...
$$\omega = \sqrt{\frac{k}{m}}$$, as the term infront of the $x$ in equation~\eqref{eq:linearequation} is $\omega^2$. Thus, we can further define the period as $$T = 2\pi \sqrt{\frac{m}{k}}$$ and the frequency as $$f = \frac{1}{2\pi} \sqrt{\frac{k}{m}}$$
...
FIXME pendulum derivation of period
FIXME diagram of energy at equilibrium and at max angle
FIXME in boko problem

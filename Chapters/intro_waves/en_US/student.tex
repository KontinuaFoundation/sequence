...
In the case of a spring, which we will analyze deeper, energy (by the form of stretching or pushing) is transfered thoughout the medium that is the spring.

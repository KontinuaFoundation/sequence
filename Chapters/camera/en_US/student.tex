...
% Issue: https://github.com/KontinuaFoundation/sequence/issues/144 
...
A digital camera sensor is made of a material with a work function of $\Phi = 1.1\text{ electronvolts}$. If the sensor is exposed to monochromatic light with a wavelength of $\lambda = 1200\text{ n m}$, what does the resulting image look like? Why?

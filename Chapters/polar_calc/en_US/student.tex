...
position. As we have talked about, you can use polar coordinates to represent circular points. To review another way to represent a position in $2D$ space is with \textbf{
...
of rotation from the $x$ axis (see Figure-\ref{fig:polarex}). 
...
% note that there are other forms we will not discuss
\end{mdframed}

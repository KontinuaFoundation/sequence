...
\hline
Shoe size & Number of pets owned & \\
\hline
...
\hline
Shoe size & Number of pets owned & Zero \\
\hline
...
\begin{figure}[H]
    ...
    \end{axis}
    \end{tikzpicture}
    \caption{Scatterplot of father and son heights for a sample of 10 pairs.}
    \label{fig:fatherson}
\end{figure}
...
dataset, the computed value is approximately $r = 0.90$.
...
should be approximately \texttt{0.90}.
...
to have taller sons. The value is $0.90$, which falls in the very

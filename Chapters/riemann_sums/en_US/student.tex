...
\begin{figure}[H]
	\centering
	\begin{tikzpicture}
		\begin{axis}[axis lines = center, xmin=0, xmax=1.02, xlabel=$t$(sec), ymin=-5, ymax=5, ylabel=$v$(m/s), ylabel style={yshift=-0.5ex,anchor=east}]
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[axis lines = center, xmin=0, xmax=1.02, xlabel=$t$ (sec), ymin=-5, ymax=5, ylabel=$v$ (m/s), ylabel style={yshift=-0.5ex,anchor=east}]
			...
			\fill[gray!30, opacity=0.4] (c0) -- (c1) -- (c2) -- cycle;
		\end{axis}
	\end{tikzpicture}
...
\begin{Exercise}[label=units1]
	...
	\begin{tikzpicture}
		\begin{axis}
			...
			\fill[gray!30, opacity=0.4](0,-3)--(3,0)--(0,0)--cycle;
			\fill[gray!30, opacity=0.4](3,0) -- (6,0) -- (6, 3)--cycle;
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}
			...
			\fill[gray!30, opacity=0.4, variable=\x](0,0)--plot ({\x}, {sin(deg(\x))+\x})--(3.141592, 0);
			\addplot[blue, samples=50, domain=0:3.141592, thick]{sin(deg(x))+x};
			\node[font=\LARGE] at (2.094395, 1.5) {$A$};
		\end{axis}
	\end{tikzpicture}
	\caption{$f(x) = \sin{x}+x$}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[axis lines = center,
			...
			\node[font=\large] at (0.3925, 0.5) {$A_1$};
			\node[font=\large] at (1.1775, 0.5) {$A_2$};
			\node[font=\large] at (1.9625, 0.5) {$A_3$};
			\node[font=\large] at (2.7475, 0.5) {$A_4$};
		\end{axis}
	\end{tikzpicture}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[axis lines = center,
				xmin=0, xmax=3.15, xlabel=$x$, xtick={0, 0.785398, 1.570796, 2.356194, 3.141593}, xticklabels={$0$, $\frac{\pi}{4}$, $\frac{\pi}{2}$, $\frac{3\pi}{4}$, $\pi$},
				ylabel=$y$, ymin =0, ymax=3.25, ytick={1, 2, 3}, yticklabels={$1$, $2$, $3$}]
			\filldraw[fill=gray!30, opacity=0.4] (0,0) rectangle (0.785, 1.4925);
			\filldraw[fill=gray!30, opacity=0.4] (0.785398, 0) rectangle (1.570796, 2.5708);
			\filldraw[fill=gray!30, opacity=0.4] (1.570796, 0) rectangle (2.356194, 3.0633);
			\filldraw[fill=gray!30, opacity=0.4] (2.356194, 0) rectangle (3.141592, 3.141592);
			\addplot[blue, thick, samples=50, domain=0:3.141592]{sin(deg(x))+x};
			\node[font=\large] at (0.3925, 0.5) {$R_1$};
			\node[font=\large] at (1.1775, 0.5) {$R_2$};
			\node[font=\large] at (1.9625, 0.5) {$R_3$};
			\node[font=\large] at (2.7475, 0.5) {$R_4$};
		\end{axis}
	\end{tikzpicture}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[axis lines = center,
				xmin=0, xmax=3.15, xlabel=$x$, xtick={0, 0.785398, 1.570796, 2.356194, 3.141593}, xticklabels={$0$, $\frac{\pi}{4}$, $\frac{\pi}{2}$, $\frac{3\pi}{4}$, $\pi$},
				ylabel=$y$, ymin =0, ymax=3.25, ytick={1, 2, 3}, yticklabels={$1$, $2$, $3$}]
			\filldraw[fill=gray!30, opacity=0.4] (0,0) rectangle (0.785, 0);
			\filldraw[fill=gray!30, opacity=0.4] (0.785398, 0) rectangle (1.570796, 1.4925);
			\filldraw[fill=gray!30, opacity=0.4] (1.570796, 0) rectangle (2.356194, 2.5708);
			\filldraw[fill=gray!30, opacity=0.4] (2.356194, 0) rectangle (3.141592, 3.0633);
			\node[font=\large] at (0.3925, 0.5) {$R_1$};
			\node[font=\large] at (1.1775, 0.5) {$R_2$};
			\node[font=\large] at (1.9625, 0.5) {$R_3$};
			\node[font=\large] at (2.7475, 0.5) {$R_4$};
	...
	\begin{subfigure}{0.48\textwidth}
		...
		\begin{tikzpicture}
			\begin{axis}
				...
				\filldraw[fill=gray!30, opacity=0.4, draw=black](0,0) rectangle (0.31416, 0);
				\filldraw[fill=gray!30, opacity=0.4, draw=black](0.31416, 0) rectangle (0.62832, 0.62318);
				\filldraw[fill=gray!30, opacity=0.4, draw=black](0.62832, 0) rectangle (0.94248, 1.2161);
				\filldraw[fill=gray!30, opacity=0.4, draw=black](0.94248, 0) rectangle (1.25664, 1.75149);
				\filldraw[fill=gray!30, opacity=0.4, draw=black](1.25664, 0) rectangle (1.57080, 2.20769);
				\filldraw[fill=gray!30, opacity=0.4, draw=black](1.57080, 0) rectangle (1.88496, 2.5708);
				\filldraw[fill=gray!30, opacity=0.4, draw=black](1.88496, 0) rectangle (2.19911, 2.83601);
				\filldraw[fill=gray!30, opacity=0.4, draw=black](2.19911, 0) rectangle (2.51327, 3.00813);
				\filldraw[fill=gray!30, opacity=0.4, draw=black](2.51327, 0) rectangle (2.82743, 3.10106);
				\filldraw[fill=gray!30, opacity=0.4, draw=black](2.82743, 0) rectangle (3.14159, 3.13645);
				\addplot[blue, thick, samples=100, domain=0:3.141592]{sin(deg(x))+x};
			\end{axis}
		\end{tikzpicture}
		\caption{Left-endpoint Riemann sum}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.48\textwidth}
		\centering
		\begin{tikzpicture}
			\begin{axis}
				[axis lines = center,
					...
					width=\linewidth,
					height=0.7\linewidth]
				\filldraw[fill=gray!30, opacity=0.4, draw=black](0,0) rectangle (0.31416, 0.62318);
				\filldraw[fill=gray!30, opacity=0.4, draw=black](0.31416, 0) rectangle (0.62832, 1.2161);
				\filldraw[fill=gray!30, opacity=0.4, draw=black](0.62832, 0) rectangle (0.94248, 1.75149);
				\filldraw[fill=gray!30, opacity=0.4, draw=black](0.94248, 0) rectangle (1.25664, 2.20769);
				\filldraw[fill=gray!30, opacity=0.4, draw=black](1.25664, 0) rectangle (1.57080, 2.5708);
				\filldraw[fill=gray!30, opacity=0.4, draw=black](1.57080, 0) rectangle (1.88496, 2.83601);
				\filldraw[fill=gray!30, opacity=0.4, draw=black](1.88496, 0) rectangle (2.19911, 3.00813);
				\filldraw[fill=gray!30, opacity=0.4, draw=black](2.19911, 0) rectangle (2.51327, 3.10106);
				\filldraw[fill=gray!30, opacity=0.4, draw=black](2.51327, 0) rectangle (2.82743, 3.13645);
				\filldraw[fill=gray!30, opacity=0.4, draw=black](2.82743, 0) rectangle (3.14159, 3.14159);
				\addplot[blue, thick, samples=100, domain=0:3.141592]{sin(deg(x))+x};
			\end{axis}
		\end{tikzpicture}
		\caption{Right-endpoint Riemann sum}
	\end{subfigure}

	\caption{Riemann sum approximations of $f(x)=\sin x + x$ on $[0,\pi]$ using 10 equal subintervals.}
	\label{fig:tenintervals}
\end{figure}



The total area for the left-determined rectangles is $\approx 6.4248$, and for the right-determined, it is $\approx7.4118$. Therefore, we have narrowed the range for the true area under the curve to $6.4248<A<7.4118$. In general, as you increase the number of intervals, you get closer to the true area.
...
\begin{Answer}[ref=rsum1]
	...
	\begin{tikzpicture}
		\begin{axis}
			...
			\filldraw[fill=gray!30, opacity=0.4, draw=black](1,0) rectangle (1.25, 0.8);
			\filldraw[fill=gray!30, opacity=0.4, draw=black](1.25, 0) rectangle (1.5, 0.6667);
			\filldraw[fill=gray!30, opacity=0.4, draw=black](1.5, 0) rectangle (1.75, 0.5714);
			\filldraw[fill=gray!30, opacity=0.4, draw=black](1.75, 0) rectangle (2, 0.5);
	...
	\begin{tikzpicture}
		\begin{axis}
			[axis lines = center,
				xmin=.5, xmax=2.5, xlabel=$x$, xtick={1, 2}, xticklabels={$1$, $2$},
				ylabel=$y$, ymin =0, ymax=1.25, ytick={0.5, 1}, yticklabels={$0.5$, $1$}]
			\filldraw[fill=gray!30, opacity=0.4, draw=black](1,0) rectangle (1.25, 1);
			\filldraw[fill=gray!30, opacity=0.4, draw=black](1.25, 0) rectangle (1.5, 0.8);
			\filldraw[fill=gray!30, opacity=0.4, draw=black](1.5, 0) rectangle (1.75, 0.6667);
			\filldraw[fill=gray!30, opacity=0.4, draw=black](1.75, 0) rectangle (2, 0.5714);
			\addplot[blue, samples=100]{1/x};
		\end{axis}
	\end{tikzpicture}	\\
...
\begin{figure}[H]
	...
	\begin{tikzpicture}[scale=1.5]
		\begin{axis}
			...
			\fill[gray!30, opacity=0.4, variable=\x, domain=0.6:3.6]
			(0.6,0) -- plot({\x}, {(1-\x)*(\x-2)*(\x-3)+3}) -- (3.6, 0) -- cycle;
			...
			\node[] at (0.79, 1) {$A_1$}; %labeling sections
			\node[] at (1.16, 1) {$A_2$};
			\node[] at (2.3, 1) {$A_i$};
			\node[] at (3.4, 1) {$A_n$};
			\node[] at (1.55,1) {\ldots};
...
\index{right riemann sums}
As seen above, a \newterm{right Riemann sum} uses the right-most value of $f(x)$ to determine the height of the rectangle (an example is shown in figure \ref{fig:rightriemann}). We will refer to the right Riemann sum as $R_n$, where $n$ is the number of intervals.

\begin{figure}[H]
	\centering
	\begin{tikzpicture}
		\begin{axis}[axis lines = center, xmin=0.75, xmax=3, ymin=0, xlabel=$x$, ylabel=$f(x)$]
			\filldraw[fill=gray!30, draw=black, opacity=0.4] (1,0) rectangle (1.5,0.667);
			\filldraw[fill=gray!30, draw=black, opacity=0.4] (1.5,0) rectangle (2, 0.5);
			\filldraw[fill=gray!30, draw=black, opacity=0.4] (2,0) rectangle (2.5, 0.4);
			\filldraw[fill=gray!30, draw=black, opacity=0.4] (2.5,0) rectangle (3, 0.333);
...
\index{left riemann sums}
When taking a \newterm{left Riemann sum}, the height of the rectangle is determined by the value of the function at the lower (left-most) $x$-value. See figure \ref{fig:leftriemann}. We will refer to left Riemann sums as $L_n$, where $n$ is the number of intervals. So, the total area approximated by a Left Riemann sum is $$L_n = f(x_0)\Delta x + f(x_1)\Delta x + \ldots + f(x_{n-1})\Delta x$$

\begin{figure}
	\centering
	\begin{tikzpicture}
		\begin{axis}[axis lines = center, xmin=0.75, xmax=3, ymin=0, xlabel=$x$, ylabel=$f(x)$]
			\filldraw[fill=gray!30, draw=black, opacity=0.4] (1,0) rectangle (1.5,1);
			\filldraw[fill=gray!30, draw=black, opacity=0.4] (1.5,0) rectangle (2, 0.667);
			\filldraw[fill=gray!30, draw=black, opacity=0.4] (2,0) rectangle (2.5, 0.5);
			\filldraw[fill=gray!30, draw=black, opacity=0.4] (2.5,0) rectangle (3, 0.4);
			\addplot[blue, thick, samples=100, domain=0.75:3]{1/x};
			\addplot[mark=*, blue, only marks]coordinates{(1,1) (1.5,0.667) (2, 0.5) (2.5,.4) (3,0.333)};
		\end{axis}
	\end{tikzpicture}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[axis lines = center, xmin=0.75, xmax=3, ymin=0, xlabel=$x$, ylabel=$f(x)$]
			\filldraw[fill=gray!30, draw=black, opacity=0.4] (1,0) rectangle (1.5,0.8);
			\filldraw[fill=gray!30, draw=black, opacity=0.4] (1.5,0) rectangle (2, 0.571);
			\filldraw[fill=gray!30, draw=black, opacity=0.4] (2,0) rectangle (2.5, 0.444);
			\filldraw[fill=gray!30, draw=black, opacity=0.4] (2.5,0) rectangle (3, 0.364);
			\addplot[blue, thick, samples=100, domain=0.75:3]{1/x};
			\addplot[mark=*, blue, only marks]coordinates{(1,1) (1.5,0.667) (2, 0.5) (2.5,.4) (3,0.333)};
...
We have established that the \emph{Left Riemann Sums} are an \emph{underestimate} and \emph{Right Riemann Sums} are an \emph{overestimate}, generally speaking for increasing functions. The \emph{Midpoint Riemann Sum} generally gets more accurate, but still only uses one point of reference for the estimation. What if, instead, we used two? Specifically, we could use the two upper corners of the rectangle, which, if at different heights, form a trapezoid. Recall that the area of a trapezoid is ${\displaystyle A={\dfrac {(a+b)}{2}}h}$. This allows us to use what is called the \newterm{Trapezoidal Rule}.
...
We have established that $f(x)$ is increasing on $[0, \pi]$. What we want to do is take the \emph{average} of the left and right riemann sums. On each subinterval, the left Riemann sum uses a rectangle with height f$(x_i)$, while the right Riemann sum uses a rectangle with height $f(x_{i+1})$. Averaging these two rectangle areas gives
...
$$L_{10}\approx 6.4248, \qquad R_{10}\approx 7.4118$$
...
\begin{axis}[
    ...
    xlabel=$x$,
    ylabel=$y$,
    xtick={0,0.785398,1.570796,2.356194,3.141593},
...
% --- T4 trapezoids ---
\filldraw[fill=gray!30,draw=black,opacity=0.5]
(0,0)--(0,0)--(0.785398,1.4925)--(0.785398,0)--cycle;

\filldraw[fill=gray!30,draw=black,opacity=0.5]
(0.785398,0)--(0.785398,1.4925)--(1.570796,2.5708)--(1.570796,0)--cycle;

\filldraw[fill=gray!30,draw=black,opacity=0.5]
(1.570796,0)--(1.570796,2.5708)--(2.356194,3.0633)--(2.356194,0)--cycle;

\filldraw[fill=gray!30,draw=black,opacity=0.5]
(2.356194,0)--(2.356194,3.0633)--(3.141593,3.1416)--(3.141593,0)--cycle;
...
\addplot[blue,thick,samples=200,domain=0:3.141593]
{sin(deg(x))+x};
...
\begin{axis}[
    ...
    xlabel=$x$,
    ylabel=$y$,
    xtick={0,0.31416,0.62832,0.94248,1.25664,1.57080,
           1.88496,2.19911,2.51327,2.82743,3.14159},
    xticklabels={$0$,$\frac{\pi}{10}$,$\frac{\pi}{5}$,
                 $\frac{3\pi}{10}$,$\frac{2\pi}{5}$,
                 $\frac{\pi}{2}$,$\frac{3\pi}{5}$,
                 $\frac{7\pi}{10}$,$\frac{4\pi}{5}$,
                 $\frac{9\pi}{10}$,$\pi$},
    ytick={1,2,3},
    yticklabels={$1$,$2$,$3$}
]
...
% --- T10 trapezoids ---
\filldraw[fill=gray!30, opacity=0.4, draw=black]
			(0,0)--(0,0)--(0.31416,0.62318)--(0.31416,0)--cycle;

			\filldraw[fill=gray!30, opacity=0.4, draw=black]
			(0.31416,0)--(0.31416,0.62318)--(0.62832,1.21610)--(0.62832,0)--cycle;

			\filldraw[fill=gray!30, opacity=0.4, draw=black]
			(0.62832,0)--(0.62832,1.21610)--(0.94248,1.75150)--(0.94248,0)--cycle;

			\filldraw[fill=gray!30, opacity=0.4, draw=black]
			(0.94248,0)--(0.94248,1.75150)--(1.25664,2.20770)--(1.25664,0)--cycle;

			\filldraw[fill=gray!30, opacity=0.4, draw=black]
			(1.25664,0)--(1.25664,2.20770)--(1.57080,2.57080)--(1.57080,0)--cycle;

			\filldraw[fill=gray!30, opacity=0.4, draw=black]
			(1.57080,0)--(1.57080,2.57080)--(1.88496,2.83602)--(1.88496,0)--cycle;

			\filldraw[fill=gray!30, opacity=0.4, draw=black]
			(1.88496,0)--(1.88496,2.83602)--(2.19911,3.00813)--(2.19911,0)--cycle;

			\filldraw[fill=gray!30, opacity=0.4, draw=black]
			(2.19911,0)--(2.19911,3.00813)--(2.51327,3.10106)--(2.51327,0)--cycle;

			\filldraw[fill=gray!30, opacity=0.4, draw=black]
			(2.51327,0)--(2.51327,3.10106)--(2.82743,3.13645)--(2.82743,0)--cycle;

			\filldraw[fill=gray!30, opacity=0.4, draw=black]
			(2.82743,0)--(2.82743,3.13645)--(3.14159,3.14159)--(3.14159,0)--cycle;
...
\caption{Trapezoidal approximations of $f(x)=\sin x+x$ on $[0,\pi]$. Increasing the number of subintervals improves the approximation.}
\label{fig:trapcompare}
\end{figure}

Here we found that, gradually, the traprule estimates the area under under the curve to a closer accuracy. 
\index{traprule|seealso{Trapezoidal Rule}}

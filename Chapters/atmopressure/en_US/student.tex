...
\begin{figure}[H]
    ...
    \caption{An air column surrounding a person experiences a large amount of pressure.}
    \label{fig:aircolumn}
\end{figure}
...
pressure as the air pushing on the outside of your rib cage.  
...
In turn, this will pull more water. Water will continue to flow from the full glass to the empty one until their surfaces are at the same level.  At this point,  the pull of gravity is the same on each side of the tube.
...
% FIXME figures here, not sure how to format given the order

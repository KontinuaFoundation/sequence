...
\section{Flying Pigs and Roller Coasters}
...
Since $r$ can be solved for $\theta$.

\section{Roller Coaster Loop}
% FIXME roller coaster loop

\section{Non-uniform circular motion}
% FIXME non-uniform circular motion section could go here

...
The 10 axioms are all stated in terms of sets. A few of them will be discussed below.
...
Note that subsets have the transitive property: $\mathbb{N}
...
about the set's \newterm{complement}: the set of everything else. For
...
See the Venn Diagram shown in Figure~\ref{fig:complement_set}.
\begin{figure}[H]
    \centering
    \begin{tikzpicture}[fill=lightgray]
...
above.)
%ADD: Chapter summary and introduce proofs as next chapter

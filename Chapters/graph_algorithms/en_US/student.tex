...
Howeverm notice that \textit{Build Frontend} and \textit{Build Backend} are not dependent on each other, so they could be done in \emph{parallel}. The \textit{Test} task cannot begin until both builds have finished.

...
We have given names to different ranges of the electromagnetic spectrum in Figure~\ref{fig:electro}

%FIXME this information can be found on wikipedia likely
\begin{figure}[htbp]
    \centering
    \begin{tabular}{r | l | l}
      Name & Hertz & Meters \\
      \hline
    Gamma rays  & $10^{20} - 10^{24}$ & $10^{-14} - 10^{-11}$\\
    X-rays  & $10^{16} - 10^{20}$ & $10^{-11} - 10^{-8}$\\
    Ultraviolet  & $10^{15} - 10^{16}$ & $10^{-8} - 10^{-7}$\\
    Blue & $\sim 6\times10^{14}$ & $\sim 5\times10^{-7}$\\
    Red  & $\sim 4\times10^{14}$ & $\sim 7\times10^{-7}$\\
    Infrared  & $10^{12} - 10^{14}$ & $10^{-6} - 10^{-3}$\\
    Microwaves  & $10^{9} - 10^{12}$ & $10^{-3} - 10^{-1}$\\
    Radio waves  & $10^{3} - 10^{9}$ & $10^{-1} - 10^{5}$\\
    \end{tabular}

    \caption{A table of different ranges of the electromagnetic spectrum.}
    \label{fig:electro}
\end{figure}
...
\item In many places, permafrost, which has trapped large amounts of
  methane in the ground for millennia, is melting.
\end{itemize}
...
air. Additionally, a great deal of water in the air is in the form of clouds, which

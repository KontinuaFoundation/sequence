...
% the last chapter was loosely related to this but not really a vector-valued function
...
\begin{figure}[htbp]
    ...
    \caption{An example of a vector-valued function.}
    \label{fig:velfuncpos}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \end{tikzpicture}
    \caption{The derivatives of the position function (velocity) with respect to time.}
    \label{fig:velfuncvel}
\end{figure}
...
\begin{figure}[htbp]
      ...
      \begin{tikzpicture} [scale=0.5, tdplot_main_coords, axis/.style={->,sdkblue}, 
            ...
            \filldraw[black] (11.42252,6,0) circle(4pt);
      \end{tikzpicture}
      \caption{The acceleration vector is constant and points downward.}
      \label{fig:velfuncaccel}
\end{figure}

...
similar chemical properties. \index{Lewis dot diagram} \index{valence electron}
...
\begin{center}
\begin{tikzpicture}
\node[font=\Huge] at (0,0) {C};
\draw[dashed] (-0.5, -0.5) rectangle (0.5, 0.5);
\end{tikzpicture}
\end{center}

Each side of the box can show a maximum of 2 electrons, for a total of 8 (any 
atom will have \textit{at most} 8 valence electrons). When filling in a Lewis dot 
diagram, \textit{each side must have one electron before adding a second 
electron}. Here is the usual order electrons are filled in:

\begin{center}
    \begin{tikzpicture}
        \node[font=\Huge] at (0,0) {C};
        \draw[dashed] (-0.5, -0.5) rectangle (0.5, 0.5);
        \draw[fill=white] (-0.167, 0.5) circle (1mm) node[font=\tiny] {1}; 
        \draw[fill=white] (0.167, 0.5) circle (1mm) node[font=\tiny] {5};
        \draw[fill=white] (0.5, 0.167) circle (1mm) node[font=\tiny] {2};
        \draw[fill=white] (0.5, -0.167) circle (1mm) node[font=\tiny] {6};
        \draw[fill=white] (0.167, -0.5) circle (1mm) node[font=\tiny] {3};
        \draw[fill=white] (-0.167, -0.5) circle (1mm) node[font=\tiny] {7};
        \draw[fill=white] (-0.5, -0.167) circle (1mm) node[font=\tiny] {4};
        \draw[fill=white] (-0.5, 0.167) circle (1mm) node[font=\tiny] {8};
    \end{tikzpicture}
\end{center}

It doesn't matter if you start drawing electrons on the top, sides, or bottom; 
what is important is that you have one electron on each side before pairing them 
up. Since carbon has 4 valence electrons, there should be one on each side:

\begin{center}
    \begin{tikzpicture}
        \node[font=\Huge] at (0,0) {C};
        \draw[fill=black] (-0.167, 0.5) circle (0.75mm);
        \draw[fill=black] (0.5, 0.167) circle (0.75mm);
        \draw[fill=black] (0.167, -0.5) circle (0.75mm);
        \draw[fill=black] (-0.5, -0.167) circle (0.75mm);
    \end{tikzpicture}
\end{center}

\begin{Exercise}[title = {Lewis Dot Diagrams}, label = lewis]
...
\begin{Answer}[ref = lewis]
\begin{center}
    \begin{tikzpicture}
        \node[font = \huge] at (-3,0) {Xe};
        \draw[fill=black] (-3.167, 0.5) circle (0.75mm);
        \draw[fill=black] (-2.833, 0.5) circle (0.75mm);
        \draw[fill=black] (-2.4, 0.167) circle (0.75mm);
        \draw[fill=black] (-2.4, -0.167) circle (0.75mm);
        \draw[fill=black] (-2.833, -0.5) circle (0.75mm);
        \draw[fill=black] (-3.167, -0.5) circle (0.75mm);
        \draw[fill=black] (-3.6, 0.167) circle (0.75mm);
        \draw[fill=black] (-3.6, -0.167) circle (0.75mm);

        \node[font=\huge] at (-1, 0) {Ra};
        \draw[fill=black] (-1.167, 0.5) circle (0.75mm);
        \draw[fill=black] (-0.4, 0.167) circle (0.75mm);
        
        \node[font=\huge] at (1, 0) {Se};
        \draw[fill=black] (0.833, 0.5) circle (0.75mm);
        \draw[fill=black] (1.167, 0.5) circle (0.75mm);
        \draw[fill=black] (1.6, 0.167) circle (0.75mm);
        \draw[fill=black] (1.6, -0.167) circle (0.75mm);
        \draw[fill=black] (1.167, -0.5) circle (0.75mm);
        \draw[fill=black] (0.4, -0.167) circle (0.75mm);

        \node[font=\huge] at (3, 0) {K};
        \draw[fill=black] (2.833, 0.5) circle (0.75mm);
    \end{tikzpicture}
\end{center}
\end{Answer}
...
\begin{center}
    \begin{tikzpicture}
        \node[font = \Large] at (0,0) {O};
        \node[font = \Large] at (-0.707, -0.707) {H};
        \node[font = \Large] at (0.707, -0.707) {H};
        \draw[thick] (-0.25, -0.15) -- (-0.6, -0.45);
        \draw[thick] (0.25, -0.15) -- (0.6, -0.45);
        \draw[fill=black] (-0.267, 0.133) circle (0.4mm);
        \draw[fill=black] (-0.133, 0.267) circle (0.4mm);
        \draw[fill=black] (0.267, 0.133) circle (0.4mm);
        \draw[fill=black] (0.133, 0.267) circle (0.4mm);
     \end{tikzpicture}
\end{center}
...
together by a \textit{triple covalent bond}: \index{double covalent bond} 
\index{double bond} \index{triple covalent bond} \index{triple bond}

\begin{center}
    \begin{tikzpicture}
        \node[font = \Large] at (-0.45, -0.5) {N};
        \node[font = \Large] at (0.45, -0.5) {N};
        \draw[thick] (-0.2, -0.5) -- (0.2, -0.5);
        \draw[thick] (-0.2, -0.4) -- (0.2, -0.4);
        \draw[thick] (-0.2, -0.6) -- (0.2, -0.6);
        \draw[fill=black] (-0.7, -0.57) circle (0.4mm);
        \draw[fill=black] (-0.7, -0.43) circle (0.4mm);
        \draw[fill=black] (0.7, -0.57) circle (0.4mm);
        \draw[fill=black] (0.7, -0.43) circle (0.4mm);

        \node[font = \Large] at (-0.45, 0.5) {O};
        \node[font = \Large] at (0.45, 0.5) {O};
        \draw[thick] (-0.2, 0.43) -- (0.2, 0.43);
        \draw[thick] (-0.2, 0.57) -- (0.2, 0.57);
        \draw[fill=black] (-0.53, 0.77) circle (0.4mm);
        \draw[fill=black] (-0.37, 0.77) circle (0.4mm);
        \draw[fill=black] (-0.53, 0.22) circle (0.4mm);
        \draw[fill=black] (-0.37, 0.22) circle (0.4mm);
        \draw[fill=black] (0.53, 0.77) circle (0.4mm);
        \draw[fill=black] (0.37, 0.77) circle (0.4mm);
        \draw[fill=black] (0.37, 0.22) circle (0.4mm);
        \draw[fill=black] (0.53, 0.22) circle (0.4mm);
...
You'll learn why different orders of covalent bonds form in Sequence 2. For now, 
you just need to know that lines on Lewis dot diagrams represent shared electrons. 

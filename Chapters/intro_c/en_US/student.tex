...
an error if you read a uninitialized variable, it will just give you
...
\texttt{main}.  Each functions only sees its own blackboard.
...
it can consumes all available memory.

...
This \texttt{gcc} is the compiler that turns your C code into an executable.  The \texttt{hello.c} is the input file, and \texttt{-o hello} tells the compiler to name the output executable \texttt{hello}. On macOS and Linux systems, this may come pre installed. On Windows, however, this likely is not installed. You can find the installation instructions \href{https://www.mingw-w64.org/downloads/}{here}.

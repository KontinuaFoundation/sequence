...
In other words, fewer molecules have high speeds, and more molecules cluster near lower speeds. Let's look at an example.
...
So, 0 degrees Celsius is 273.15 degrees Kelvin, and 100 degrees Celsius is 373.15 degrees Kelvin.\index{Kelvin}
...
Let's say it's dawn, and a person is lying on a half-full air mattress in a field. The weight of the person will keep the pressure of the air inside constant (or pretty close). 
\begin{figure}[H]
    \centering
...
These intermolecular forces are beyond the scope of this course, but they called Van der Waals forces and hydrogen bonds.  

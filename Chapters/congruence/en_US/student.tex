...
Let's look at this another way by laying one triangle on top of the other:
...
\item Side-Side-Right: They are right triangles and have two sides the same measure
\end{itemize}

% added CPCTC HERE - arjan
...
\begin{Exercise}[title={Congruent Triangles}, label=con_triangles]
  ...
  and angles that he measured. For each pair of triangles, write whether

...
If a liter of paint covers 6 square meters and the logo is 5 meters 
...
exactly one point, as shown in figure \ref{fig:tan1}.
\begin{figure}[H]
    \centering
    \begin{tikzpicture}
        \filldraw [black] (0,0) circle (2pt);
    ...
    \end{tikzpicture}
    \caption{A line that is \emph{tangent} to the circle.}
    \label{fig:tan1}
\end{figure}

The tangent line is always perpendicular to the radius to the point of tangency, as in figure \ref{fig:tan2}.
\begin{figure}[H]
    \centering
    \begin{tikzpicture}
      \filldraw [black] (0,0) circle (2pt);
      ...
      \draw [sdkblue, thick] (6.243, -2) -- (0, 4.243);
    \end{tikzpicture}
    \caption{The radius and tangent line are perpendicular.}
    \label{fig:tan2}
\end{figure}

A secant line intersects a circle at \emph{two points}, as shown in figure~\ref{fig:sec3}.\index{secant}
\begin{figure}[H]
    \centering
    \begin{tikzpicture}[scale=1]
        ...
        % Secant line
        \draw[sdkblue, thick] (-4, -1.5) -- (4, 2);

        \filldraw[sdkblue] (-2.83225, -0.98911) circle (2pt);
        \filldraw[sdkblue] (2.64865, 1.40878) circle (2pt);
    \end{tikzpicture}
    \caption{A line that is \emph{secant} to the circle.}
    \label{fig:sec3}
\end{figure}
  
Notice that the secant line crosses the circle at two points, similar to how a chord intersects a circle. Every chord lies on a secant line but not every secant line contains a chord.
These definitions are important, because secants and tangents will come up in calculus chapters in the future, so be able to recognize them. In calculus, we will use tangent lines to approximate the behavior of curves at instantaneous points, and secant lines to compute average rates of change.

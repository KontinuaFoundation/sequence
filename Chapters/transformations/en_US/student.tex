...
such that any coefficient $x_1$ and $x_2$ are unchanged, while $e_1$ and $e_2$ are transformed. Thus, linear transformations preserve linear combinations while \emph{altering the directions that define the coordinate system}. This will be better visualized in the next examples.

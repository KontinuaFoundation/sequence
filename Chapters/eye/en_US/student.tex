...
\newterm{farsighted} or \newterm{hyperoptic}. The objects which are distant can appear clearly, while closer objects are heavily blurred. 
...
% talk about multiple colors of eye phenomeon? ehh probably not necessary but would be cool

...
Yes, the probabilities of all the possibilities still add to 1. This is only true because \emph{the events do not effect each other}; the events are \textbf{\textit{independent}}. 

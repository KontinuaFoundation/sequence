...
Yes, the probabilitites of all the possibilities still add to 1. This is only true because \emph{the events do not effect each other}; the events are \textbf{\textit{independent}}. 
...
\begin{itemize}
  ...
  \item Imply means suggests in this sense, as in \textit{there is evidence for}
  \item Causation means there is a cause and effect relationship in place between the two variables. 
\end{itemize}

So saying correlation does not imply causation simply means just because two variables are linearly connected; it connect be said one variable causes the other. 

Here are some examples:
\begin{itemize}
  \item Ice Cream Sales, Mosquito bites, and Sunburn cases all increase during the summertime. However, none of these are causally connected 
  ...
  \item There was a large increase in toilet paper sales and people working from home in the years 2020-2021. Does this mean that one causes the other? Not necessarily, in this case a third factor $C$, the pandemic, cause a large global quarantine, leading to increased toilet paper usage and inability to work in an office. 
\end{itemize}
...
\begin{figure}[htbp]
    ...
    \caption{A histogram of probabilities of dice sums. This is referred to as a bell curve.}

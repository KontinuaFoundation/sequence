...
The amount of friction is also determined by the materials that are sliding against each other. For example, if the floor is ice, the frictional force will be less than if the floor is made of wood. Written mathematically, we can express the force of friction as
$$F_{f} = \mu N$$
...
\textbf{How fast do you accelerate now that the sled is moving?}

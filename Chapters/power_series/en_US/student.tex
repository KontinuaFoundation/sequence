...
to test the endpoints of the window of convergence to determine if the 
interval is open or closed. Thus, there are four possibilities for the interval 
of convergence:
...
\Needspace{12\baselineskip}  % force include space to make figure avoid floating to next page
\begin{figure}[H] 
\centering
    \begin{tikzpicture}

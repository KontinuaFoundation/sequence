...
queue for use with Dijkstra's Algorithm. Using it will look like this algorithm called a \newterm{priority queue}:
...
so that Denver and Phoenix have the same cost:
...
arbitrary ordering, but it will work for this problem.  Add a method to
...
% FIXME should time complexity be mentioned/
...
%FIXME also more diagrams would be helpful here
\begin{enumerate}

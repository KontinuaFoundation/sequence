...
$\Delta A = \Delta x \Delta y$ (see figure \ref{fig:subrectangles}). 
...
Each subrectangle is defined by:
...
y_{ij}^*)$ (see figure \ref{fig:one_column}) and the volume of the column is 
given by:
